        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Wallets_Institutions_InstitutionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstitutionsEmployees", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InstitutionsEmployees_Institutions_InstitutionId",
                        column: x => x.InstitutionId,
                        principalTable: "Institutions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InstitutionsEmployees_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MoneyTransaction = table.Column<float>(type: "real", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentHistorys_Wallets_WalletId",
                        column: x => x.WalletId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstitutionsEmployees_InstitutionId",
                table: "InstitutionsEmployees",
                column: "InstitutionId");

            migrationBuilder.CreateIndex(
                name: "IX_InstitutionsEmployees_UserId",
                table: "InstitutionsEmployees",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentHistorys_WalletId",
                table: "PaymentHistorys",
                column: "WalletId");

            migrationBuilder.CreateIndex(
                name: "IX_Wallets_InstitutionId",
                table: "Wallets",
                column: "InstitutionId",
                unique: true);
        }
